...
# Katie London,11.15.2021,Modified code to complete assignment 6
# ---------------------------------------------------------------------------- #
...
class Processor:
    ...
    def read_data_from_file(file_name, list_of_rows):
        ...
        :return: (string) function execution successful
        """
    ...
    def add_data_to_list(task, priority, list_of_rows):
        """ Add a new task and priority onto the list

        :param task: (string) with name of task:
        :param priority: (string) with priority number:
        :param list_of_rows: (list) you want filled with file data:
        :return: (list) of dictionary rows
        :return: (string) function execution successful status
        """
    ...
    def write_data_to_file(file_name, list_of_rows):
        """ Write the data stored in the list of dictionary rows to a file

        :param file_name: (string) name of the text file in which to write the list
        :param list_of_rows: (list) you want filled with file data:
        :return: (list) of dictionary rows
        :return: (string) function execution successful
        """
...
class IO:
    ...
    def input_new_task_and_priority():
        ...
        priority = input("Please enter the priority for " + task +": ")
    ...
    def input_task_to_remove():
        ...
        :return: string
        """
        return input("Please enter the name of the task you would like to remove: ")
